...
Qurani is a free, open-source Quran app. We respect your privacy and are committed to protecting it.

## Data We Collect

### Location (GPS)
Used **only locally on your device** to calculate prayer times and Qibla direction. Your location is never sent to any server, never stored permanently, and never shared with anyone.
...
|---------|---------|-----------|
| Quran.com API | Quran text, translations, tafsir | Surah/ayah numbers only |
...
Qurani does not integrate any third-party analytics, advertising, or tracking services. We do not use Firebase, Google Analytics, Facebook SDK, or any similar services.

## Children's Privacy

Qurani does not collect any personal information from anyone, including children under 13.
...
*Qurani is built as Sadaqah Jariyah (ongoing charity). We have no interest in your data — only in providing a beneficial app for the Ummah.*
